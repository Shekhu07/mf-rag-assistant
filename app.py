...
with right_col:
    ...
    st.markdown(
        ...
        <style>
            ...
            div[data-testid="stVerticalBlock"]:has(.unique-chat-btn-marker):not(:has(div[data-testid="stVerticalBlock"]:has(.unique-chat-btn-marker))) {
            ...
            div[data-testid="stVerticalBlock"]:has(.unique-chat-btn-marker):not(:has(div[data-testid="stVerticalBlock"]:has(.unique-chat-btn-marker))) button {
            ...
            div[data-testid="stVerticalBlock"]:has(.unique-chat-btn-marker):not(:has(div[data-testid="stVerticalBlock"]:has(.unique-chat-btn-marker))) button:hover {
            ...
            div[data-testid="stVerticalBlock"]:has(.unique-chat-window-marker):not(:has(div[data-testid="stVerticalBlock"]:has(.unique-chat-window-marker))) {
                position: fixed !important;
            ...
            div[data-testid="stVerticalBlock"]:has(.unique-chat-window-marker):not(:has(div[data-testid="stVerticalBlock"]:has(.unique-chat-window-marker))) > div {
            ...
            div[data-testid="stVerticalBlock"]:has(.unique-chat-window-marker):not(:has(div[data-testid="stVerticalBlock"]:has(.unique-chat-window-marker))) .stChatInput {
